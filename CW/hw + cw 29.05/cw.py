...
'''
1. Класс животное => Класс Кошки, Собаки => дать_голос (Кошка замяукает, Собака загавкает)
2. Класс Сборщик (имя, логин, пароль), __получить_доступ => получаете доступ (_), в доступе отказано (__)
'''
